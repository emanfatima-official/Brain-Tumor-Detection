...
st.write("Upload an MRI image and this app will predict the type of brain tumor using a deep learning model in seconds, with accuracy of around 96%. The prediction classes include glioma, meningioma, pituitary and no tumor (healthy brain).")
